                ...
                <div class="card-body pt-0">
                    ...
                    <form method="POST" action="{{ route('backpack.auth.login') }}" autocomplete="off" novalidate="">
                        ...
                        <div class="mb-3">
                            ...
                            <input autofocus type="{{ $username==backpack_email_column()?'email':'text' }}" name="{{ $username }}" value="{{ old($username) }}" id="{{ $username }}" class="form-control {{ $errors->has($username) ? 'is-invalid' : '' }}">
