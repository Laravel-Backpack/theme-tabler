@if (backpack_auth()->check())
    <aside class="{{ backpack_theme_config('classes.sidebar') ?? 'navbar navbar-vertical navbar-right navbar-expand-lg' }} @if(backpack_theme_config('options.sidebarFixed')) navbar-fixed @endif">
